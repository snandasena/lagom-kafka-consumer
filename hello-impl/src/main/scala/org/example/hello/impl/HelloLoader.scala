...
import org.example.hello.api.{HelloService, KafkaConsumerService}
...
abstract class HelloApplication(context: LagomApplicationContext)
  ...
  lazy val kafkaConsumerService: KafkaConsumerService = serviceClient.implement[KafkaConsumerService]
